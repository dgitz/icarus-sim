...
if(Plot_PoseSignals == 1)
    ...
    if(Plot_AngularRate == 1)
        sig = convert_modelsignal(SignalClass.SIGNALCLASS_POSESIGNAL_,'xgyro',...
            out.pose_rotationrate_signals.xrotationrate.value.Time, ...
            out.pose_rotationrate_signals.xrotationrate.value.Data, ...
            out.pose_rotationrate_signals.xrotationrate.status.Data, ...
            out.pose_rotationrate_signals.xrotationrate.rms.Data);
        rotation_rate_signals{length(rotation_rate_signals)+1} = sig;
        sig = convert_modelsignal(SignalClass.SIGNALCLASS_POSESIGNAL_,'ygyro',...
            out.pose_rotationrate_signals.yrotationrate.value.Time, ...
            out.pose_rotationrate_signals.yrotationrate.value.Data, ...
            out.pose_rotationrate_signals.yrotationrate.status.Data, ...
            out.pose_rotationrate_signals.yrotationrate.rms.Data);
        rotation_rate_signals{length(rotation_rate_signals)+1} = sig;
        sig = convert_modelsignal(SignalClass.SIGNALCLASS_POSESIGNAL_,'zgyro',...
            out.pose_rotationrate_signals.zrotationrate.value.Time, ...
            out.pose_rotationrate_signals.zrotationrate.value.Data, ...
            out.pose_rotationrate_signals.zrotationrate.status.Data, ...
            out.pose_rotationrate_signals.zrotationrate.rms.Data);
        rotation_rate_signals{length(rotation_rate_signals)+1} = sig;
    end
