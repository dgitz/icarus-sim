...
block_definition{1}.name = 'InitializeSignals';
block_definition{1}.max_count = 30;
block_definition{2}.name = 'TimeCompensate';
block_definition{2}.max_count = 50;
block_definition{3}.name = 'SensorPostProcessing';
block_definition{3}.max_count = 50;
block_definition{4}.name = 'SignalLinker';
block_definition{4}.max_count = 100;
result = 0;
...
for i = 1:length(top_level_blocks)
    ...
    for j = 1:length(block_definition)
        match_str = [model_name  '/PoseSystem/'  block_definition{j}.name];
